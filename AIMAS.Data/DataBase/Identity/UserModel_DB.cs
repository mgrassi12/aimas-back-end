...
namespace AIMAS.Data.Identity
{
  public class UserModel_DB : IdentityUser<long>, IAimasDbModelWithUpdate<UserModel>
  {
    ...
    public override string UserName { get => base.UserName; set { base.UserName = value; base.NormalizedUserName = value; } }
    ...
    public override string Email { get => base.Email; set { base.Email = value; base.NormalizedEmail = value; } }
